...
getCurrentDigitImpact :: (Int, Int) -> Int
getCurrentDigitImpact (part, index) = getValueToAddToTotal(myNumberList!!index, index, getNextIndex, part)

isEqualToPrevious :: (Int, (Int, Int) -> Int, Int )  -> Bool
isEqualToPrevious (currentIndex, getPrevious, part) = myNumberList!!getPrevious(part, currentIndex) == myNumberList!!currentIndex

getValueToAddToTotal :: (Int, Int, (Int, Int) -> Int, Int ) -> Int
getValueToAddToTotal (theCurrentValue, currentIndex, getNextIndexOperator, part) = if isEqualToPrevious(currentIndex, getNextIndexOperator, part) then theCurrentValue else 0

getNextIndex :: (Int, Int) -> Int
getNextIndex (1, currentIndex) = currentIndex - 1
getNextIndex (2, currentIndex) = rem (currentIndex + div (length myNumberList) 2) (length myNumberList)

getExtraNumber :: Int -> Int
getExtraNumber 1 = 7
getExtraNumber 2 = 0
